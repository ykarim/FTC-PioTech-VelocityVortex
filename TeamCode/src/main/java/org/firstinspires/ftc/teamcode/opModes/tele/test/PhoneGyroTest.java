...
public class PhoneGyroTest extends OpMode{
    ...
    private void updateTelemetryData() {
        ...
        telemetry.addData(TAG, "Gyro Azimuth : " + GyroUtils.getAzimuth());
        telemetry.addData(TAG, "Gyro Pitch : " + GyroUtils.getPitch());
        telemetry.addData(TAG, "Gyro Roll : " + GyroUtils.getRoll());

        telemetry.addData(TAG, "Gyro Roll Speed : " + GyroUtils.getRoll(robot.gyroSensor));
